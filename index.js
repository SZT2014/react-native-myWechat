...
const { RNMyWeChat } = NativeModules;
 ...
 * @return {Promise}
 */
export const registerApp = wrapRegisterApp(RNMyWeChat.registerApp);
 ...
 * @return {Promise}
 */
export const isWXAppInstalled = wrapApi(RNMyWeChat.isWXAppInstalled);
 ...
 * @return {Promise}
 */
export const isWXAppSupportApi = wrapApi(RNMyWeChat.isWXAppSupportApi);
 ...
 */
export const getWXAppInstallUrl = wrapApi(RNMyWeChat.getWXAppInstallUrl);
 ...
 */
export const getApiVersion = wrapApi(RNMyWeChat.getApiVersion);
 ...
 * @return {Promise}
 */
export const openWXApp = wrapApi(RNMyWeChat.openWXApp);

const nativeSendAuthRequest = wrapApi(RNMyWeChat.sendAuthRequest);
...
export function sendAuthRequest(scopes, state) {
  return new Promise((resolve, reject) => {
    RNMyWeChat.sendAuthRequest(scopes, state, () => {});
